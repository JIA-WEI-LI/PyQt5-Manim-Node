...
class StyleDemo(QWidget):
    def __init__(self):
        ...
        file_dialog_button_folder = FileDialogButton(icon="nodeeditor\\resources\\icons\\icon_check.svg", text="Open Folder", filter="folder")
        file_dialog_button_file = FileDialogButton(icon="nodeeditor\\resources\\icons\\icon_check.svg", text="Open Files", filter=".all(*)")
        label = Label("Label")
